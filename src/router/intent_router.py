    ...
    while True:
        try:
            ...
            if current_actor in party:
                ...
                # Pass TOON context into the router for better contextual decisions
                ...
                if decision.get('type') == 'FIXED':
                    ...
                    if decision.get('command') == 'ATTACK':
                        ...
                        target_zone_str = decision.get('target', '').upper()
                        ...
                        try:
                            ...
                            # Apply rule: Move 1 zone per turn
                            ...
                            if abs(current_idx - target_idx) > 1:
                                # Distance > 1, correct it to 1 zone closer to the target
